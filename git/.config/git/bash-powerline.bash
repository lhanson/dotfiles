################################################################################
# bash-powerline.bash - show git repo status in our prompt
# Adapted from https://github.com/riobard/bash-powerline
################################################################################
...
__powerline() {
    ...
    ps1() {
		...
		local user_host="$COLOR_SUCCESS\u@\h$RESET"
        PS1="$user_host $cwd$git$symbol"
    }

	# Command executed by Bash just before displaying a prompt
